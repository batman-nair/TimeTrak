...
class TestMongoTrackerStore(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mg_ = tracker.MongoTrackerStore(mongo_url=mongo_url)
    ...
    def test_single_activity_data(self):
        ...
        all_activities = self.mg_.get_aggregated_user_activities(self.TEST_GUILD, 'user1')
        filtered_activites = self.mg_.get_aggregated_user_activities(self.TEST_GUILD, 'user1', from_time=first_activity_starttime+timedelta(days=1))
    ...
    def test_separated_activity_data(self):
        ...
        all_activities = self.mg_.get_aggregated_user_activities(self.TEST_GUILD, 'user2')
        new_activities = self.mg_.get_aggregated_user_activities(self.TEST_GUILD, 'user2', from_time=second_activity_startime-timedelta(seconds=1))
        last_activities = self.mg_.get_last_user_activities(self.TEST_GUILD, 'user2')
    ...
    def test_continuous_activity_data(self):
        ...
        all_activities = self.mg_.get_aggregated_user_activities(self.TEST_GUILD, 'user3')
        last_activities = self.mg_.get_last_user_activities(self.TEST_GUILD, 'user3')
    ...
    def test_reset_functions(self):
        ...
        self.assertFalse(self.mg_.get_aggregated_user_activities(self.TEST_GUILD, 'user1'), "Reset user data failed.")

        self.mg_.reset_guild_data(self.TEST_GUILD)
        self.assertFalse(self.mg_.get_aggregated_user_activities(self.TEST_GUILD, 'user2'), "Reset guild data failed.")
        self.assertFalse(self.mg_.get_aggregated_user_activities(self.TEST_GUILD, 'user3'), "Reset guild data failed.")
